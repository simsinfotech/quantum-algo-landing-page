...
export default function FundingProof({ openPopup }: { openPopup: () => void }) {
    return (
        <section id="results" className="relative pt-16 md:pt-24 pb-24 md:pb-32 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #0a0a0a 40%, #B4348C 100%)' }}>
