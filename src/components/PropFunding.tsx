...
export default function PropFunding({ openPopup }: { openPopup: () => void }) {
    ...
    return (
        <section>
            ...
            <div className="py-16 md:py-24" style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #0a0a0a 50%, #B4348C 50%, #B4348C 100%)' }}>
...
>
  Trade Like a Professional - Apply Now
            ...
            <div className="py-16 md:py-24" style={{ background: 'linear-gradient(135deg, #B4348C 0%, #B4348C 50%, #0a0a0a 50%, #0a0a0a 100%)' }}>
            ...
            <div className="py-12 sm:py-16 md:py-24" style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #0a0a0a 50%, #B4348C 50%, #B4348C 100%)' }}>
            ...
            {/* Footer */}
            <div className="py-8 sm:py-12 border-t border-white/10" style={{ background: 'linear-gradient(135deg, #B4348C 0%, #B4348C 50%, #0a0a0a 50%, #0a0a0a 100%)' }}>
